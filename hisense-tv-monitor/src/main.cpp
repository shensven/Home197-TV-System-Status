...
void setup() {
  ...
  App.pre_setup("hisense-tv-monitor", __DATE__ ", " __TIME__, false);
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  //   tx_buffer_size: 512
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: hisense-tv-monitor.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("hisense-tv-monitor.local");
